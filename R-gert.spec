...
Version  : 1.3.0
Release  : 10
URL      : https://cran.r-project.org/src/contrib/gert_1.3.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/gert_1.3.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617035206
