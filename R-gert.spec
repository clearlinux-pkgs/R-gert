...
Version  : 1.2.0
Release  : 4
URL      : https://cran.r-project.org/src/contrib/gert_1.2.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/gert_1.2.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613411846
