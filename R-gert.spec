...
Version  : 1.1.0
Release  : 3
URL      : https://cran.r-project.org/src/contrib/gert_1.1.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/gert_1.1.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611772418
